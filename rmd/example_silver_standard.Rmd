...
```{r silver1}
o = silver_standard_proto(score_table, map_table, omim_based_silver_standard, trait_code = 'phecode')
...
```{r silver2}
o = silver_standard_proto(score_table, map_table2, omim_based_silver_standard, trait_code = 'HPO')
